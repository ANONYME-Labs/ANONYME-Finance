            ...
            e.exports = (function (e) {
                ...
                function (e, t, r) {
                    ...
                    e.exports = function e(t, r, n) {
                        ...
                        (this.apiKey = t),
                            ...
                            (this.transactions = {
                                send: function (e, t) {
                                    var r = new u("fm_composeSend", { to: e.to, value: e.amount });
                                    l.getProvider().sendFortmaticAsync(r, t);
                                },
                            }),
                            (this.getProvider = function () {
                                return c["fortmatic-".concat(l.queryParams)] || (c["fortmatic-".concat(l.queryParams)] = new a.default(l.fortmaticClient, { API_KEY: t, ETH_NETWORK: r })), c["fortmatic-".concat(l.queryParams)];
                            }),
                            (this.user = {
                                login: function () {
                    ...
                    var o = n(r(6)),
                        ...
                        f = (function () {
                            function e(t, r) {
                                ...
                                (this.options = { API_KEY: r.API_KEY, ETH_NETWORK: r.ETH_NETWORK, DOMAIN_ORIGIN: window.location ? window.location.origin : "", version: c.version }),
                                                                                  ...
                                                                                  a.requests[e.id] = {
                                                                                      ...
                                                                                      cb: function (e, t) {
                                                                                          ...
                                                                                          if (e && e.response && !(0, l.findExistingResponse)(n, e.response.id))
                                                                                              throw (
                                                                                                  (n.push({ jsonrpc: "2.0", id: e.response.id, error: { code: e.response.code, message: e.response.message } }),
                ...
                function (e, t) {
                    !(function (t) {
                            ...
                            (T.prototype = b.constructor = A),
                                ...
                                (F.prototype = {
                                    ...
                                    delegateYield: function (e, t, n) {
                                        return (this.delegate = { iterator: k(e), resultName: t, nextLoc: n }), "next" === this.method && (this.arg = r), m;
                                    },
                                });
                        }
                        function _(e, t, r, n) {
                        ...
                        function I(e, t) {
                            ...
                            return a
                                ? a.done
                                    ? ((t[e.resultName] = a.value), (t.next = e.nextLoc), "return" !== t.method && ((t.method = "next"), (t.arg = r)), (t.delegate = null), m)
                                    : a
                ...
                function (e) {
                    e.exports = {
                        ...
                        scripts: { build: "WEBPACK_ENV=production webpack", "build:dev": "WEBPACK_ENV=development BABEL_ENV=development webpack --progress --colors --watch", test: "nyc --reporter=lcov --reporter=text-summary ava" },
                        ...
                        ava: {
                            ...
                            files: ["test/**/*.spec.js"],
                            babel: { testOptions: { presets: ["@babel/env"], plugins: ["@babel/plugin-proposal-function-bind", "@babel/plugin-transform-runtime"] } },
                            verbose: !0,
                        },
                        nyc: { all: !1, "check-coverage": !0, "per-file": !0, lines: 80, statements: 80, functions: 80, branches: 80, include: ["src/**/*.js"], exclude: ["*/style.js"], require: [], reporter: ["html", "lcov"] },
...
//# sourceMappingURL=1.ab9e1769.chunk.js.map
