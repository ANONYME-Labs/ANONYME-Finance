...
const underlyingAddress = batContractAddress;
const underlying = new web3.eth.Contract(batABI, batContractAddress);
...
var TokenContract = new web3.eth.Contract(DaiABI,DAIContractAddress);
