            ...
            <div class="card TableItem <?=$row['name'];?>">
              <div class="card-body" style="padding: 1rem!important;">
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-3 col-12">
                    <div>
                      <span><b class="borrow_percentagec<?=ltrim($name, 'c');?> text-danger" style="line-height: 30px;">0%</b></span>
					  </div>
                  </div>
				  <div class="col-lg-3 col-md-3 col-sm-3 col-12">
                    <div>
                      <span><b class="stable_percentagec<?=ltrim($name, 'c');?> text-danger" style="line-height: 30px;">-</b></span>
					  ...
					  <?php 
				       if($name!='cETH'){
						...
						?>
                      <button type="button" onclick="borrow('<?=$row['name'];?>');" class="btn btn-outline-info btn-sm" style="min-width: 100px;max-width: 100px;float: right;">Details</button>
                    </div>
                  </div>
                </div>
              </div>
